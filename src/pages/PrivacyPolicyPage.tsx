      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to TrailForge.</li>
            ...
            <li><strong>Website</strong> refers to TrailForge, accessible from <a href="https://trailforge.robpitcher.com" className="text-primary underline underline-offset-4 hover:text-primary/80" target="_blank" rel="noopener noreferrer">https://trailforge.robpitcher.com</a>.</li>
          ...
          <ul className="list-disc pl-6 space-y-3">
            <li>
              ...
              <p className="text-sm text-muted-foreground">Type: Session Cookies · Administered by: Us</p>
            ...
            <li>
              ...
              <p className="text-sm text-muted-foreground">Type: Persistent Cookies · Administered by: Us</p>
              <p>These Cookies identify if users have accepted the use of cookies on the Website.</p>
            </li>
            <li>
              <p><strong>Functionality Cookies</strong></p>
              <p className="text-sm text-muted-foreground">Type: Persistent Cookies · Administered by: Us</p>
              <p>These Cookies allow Us to remember choices You make when You use the Website, such as remembering your login details or language preference.</p>
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>Customer Support Data:</strong> Support tickets and correspondence retained up to 24 months from the date of ticket closure. Chat transcripts retained up to 24 months for quality assurance.</li>
            <li><strong>Usage Data:</strong> Website analytics data (cookies, IP addresses, device identifiers) retained up to 24 months from the date of collection. Server logs retained up to 24 months for security monitoring.</li>
          </ul>
          <p>We may retain Personal Data beyond the periods stated above for legal obligations, legal claims, Your explicit request, or technical limitations (e.g., data in backup systems scheduled for routine deletion).</p>
          ...
          <p>Our Service may give You the ability to delete certain information about You from within the Service. You may update, amend, or delete Your information at any time by signing in to Your Account and visiting the account settings section. You may also contact Us to request access to, correct, or delete any Personal Data that You have provided to Us.</p>
          ...
          <ul className="list-disc pl-6">
            <li>By email: <a href="mailto:trailforge@robpitcher.com" className="text-primary underline underline-offset-4 hover:text-primary/80">trailforge@robpitcher.com</a></li>
          </ul>
        </div>
      </div>
    </div>
