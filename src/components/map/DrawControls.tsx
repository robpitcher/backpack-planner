  ...
  return (
    <div className="absolute left-3 top-14 z-10 flex flex-col gap-1">
      <Button
        ...
        size="icon"
        onClick={onStartDraw}
        className="h-9 w-9 bg-white shadow-md hover:bg-gray-100 data-[active=true]:bg-orange-600 data-[active=true]:text-white data-[active=true]:hover:bg-orange-700"
      ...
      <Button
        ...
        className="h-9 w-9 bg-white shadow-md hover:bg-gray-100 data-[active=true]:bg-purple-600 data-[active=true]:text-white data-[active=true]:hover:bg-purple-700"
